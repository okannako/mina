...
impl<P> Into<ark_ff::Fp256<P>> for Fp256<P> {
    fn into(self) -> ark_ff::Fp256<P> {
        self.0
    }
}
...
/*
impl<P> ocaml::custom::Custom for Fp256<P> {
    const NAME: &'static str = "Fp256\0";
    const USED: usize = 1;
    ...
    const OPS: ocaml::custom::CustomOps = ocaml::custom::CustomOps {
        ...
        finalize: Some(Self::caml_pointer_finalizee),
